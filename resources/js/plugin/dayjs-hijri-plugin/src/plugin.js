...
export default (o, Dayjs, dayjs) => {
    ...
    proto.parse = function (cfg) {
        ...
        if (
            ...
            const [y, m, d] = hdate.G(parseInt(reg[1], 10), parseInt(reg[2], 10), parseInt(reg[3] || 1, 10));
    ...
    proto.InitHijri = function () {
        const [jy, jm, jd] = hdate.J(this.$y, this.$M + 1, this.$D);
        this.$hy = jy;
        this.$hM = jm - 1;
        this.$hD = jd;
    };
    ...
    proto.startOf = function (units, startOf) {
        ...
        switch (unit) {
            case C.Y:
                return isStartOf ? instanceFactory(1, 0) : instanceFactory(0, 0, this.$hy + 1);
            case C.M:
                return isStartOf
                    ? instanceFactory(1, this.$hM)
                    : instanceFactory(0, (this.$hM + 1) % 12, this.$hy + parseInt((this.$hM + 1) / 12, 10));
            case C.W:
                return isStartOf
    ...
    proto.daysInMonth = function () {
        ...
        return $.calendars.instance('ummalqura').daysInMonth(this.$hy, this.$hM + 1);
    };
    ...
    if (oldToArray) {
        proto.toArray = function () {
            ...
            return [this.$hy, this.$hM, this.$hD, this.$H, this.$m, this.$s, this.$ms];
        };
    }
